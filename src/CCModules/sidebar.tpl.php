...
<div class='box'>
<h4>Winnie CMF</h4>
<p>Winnie Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Winnie interface.</p>
<ul>
<?php foreach($modules as $module): ?>
